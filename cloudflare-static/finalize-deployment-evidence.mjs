...
function main(){
  ...
  process.stdout.write(`${JSON.stringify({ok:true,manifest_path:result.manifest_path,workflow_invocation_receipt:{accepted:receipt.accepted,replay_key_sha256:receipt.replay_key_sha256},closure:result.closure,...result.verification})}\n`);
}
