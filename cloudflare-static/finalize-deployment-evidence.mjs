...
export function finalizeDeploymentEvidence({directory='.',output='cloudflare-deployment-evidence-manifest.json',sourceCommit,runId,generatedAt=new Date().toISOString(),files=REQUIRED_EVIDENCE_FILES}={}){
  ...
  return{manifest_path:outputPath,manifest,verification,closure,hostname_consistency:{accepted:hostnameConsistency.evidence.accepted,errors:hostnameConsistency.evidence.errors,output_path:hostnameConsistency.output_path}};
}
