...
export function buildEvidenceAcceptance(input) {
  ...
  return {
    ...
    derivation_rule: 'Deployment acceptance requires both exact artifact/provenance binding and valid served-deployment claim evidence. Caller-supplied summary booleans are not acceptance inputs.',
